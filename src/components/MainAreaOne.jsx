...
const OriginStoryContent = () => {
  return (
    <p className="originPtag">
      <strong>Good Time Design</strong>, or <strong>"GTD"</strong> is a platform for young independent designers and design enthusiasts to raise awareness about their conceptual design projects the platform provides a means to sell and raise capital against these creative IPs.<br/><br/>
      <br/>
...
{/*           
      ...
      <Banner
            ...
            title="market"
            description="A market to raise capital and sell original conceptual design."
            heidBtn="heidBtn"
          />
